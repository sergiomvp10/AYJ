...
import { LogOut, ClipboardList, Wrench, CheckCircle } from 'lucide-react';
...
export default function MechanicDashboard({ user, onLogout }: MechanicDashboardProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Panel de Mecánico</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Reparaciones Asignadas</CardTitle>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Reparaciones asignadas a ti</CardDescription>
          </CardHeader>
          <CardContent>
            {repairs.length === 0 ? (
                ...
                <TableBody>
                  {repairs.map((repair) => (
                    <TableRow key={repair.id}>
                      ...
                      <TableCell className="max-w-xs truncate">{repair.location}</TableCell>
